...
### Neutral
- **Navy Ground** (`#020b14`): the dark section background — hero, "Find the shop", and the "field log" story section. Also the fixed dark surface for small solid UI chips (the cart badge) regardless of section.
